...
$pdf->SetMargins(PDF_MARGIN_LEFT-18, PDF_MARGIN_TOP-22, PDF_MARGIN_RIGHT-15);
...
include_once "../../admin_dashboard/config.php";
include_once "../$api_path/config/database.php";
include_once "../$api_path/config/core_distributor.php";
include_once "../$api_path/objects/employee.php";
include_once "../$api_path/admin/uploadScheduleHistoryListPdf.php";
