    ...
    <body>
        ...
        <main class="main-contents">
            <section class="bg-white brad-4 full-height" id="toggle">
                <div class="header_container">
                    <div class="header-section">
                        <div>
                            <h1 class="header_main" data-i18n="sales_order">Sales Order</h1>
                        </div>
                        <p class="table_count"><span data-i18n="total_order">Total Order</span> - <span id="total_order_count"></span></p>
                    </div>
                </div>
                <div class="dataTables_filter">
                    <form class="formdield">
                        <div class="form-group field_data">
                            <input class="form-control box_form" name="date" id="fromDate" onchange="date_filter()" type="text" placeholder="From Date" readonly data-i18n-placeholder="from_date">
                        </div>
                        <div class="form-group field_data">
                            <input class="form-control box_form" name="date" id="toDate" onchange="date_filter()" type="text" placeholder="To Date" readonly data-i18n-placeholder="to_date">
                        </div>
                    </form>
                </div>
                    ...
                    <table class="custom-table" id="table_data">
                        <thead>
                            <tr>
                                ...
                                <th data-i18n="order_number">Order Number</th>
                                <th data-i18n="date_time">Date & Time</th>
                                <th data-i18n="shop_name">Shop Name</th>
                                <th data-i18n="order_taken_by">Order Taken By</th>
                                ...
                                <th data-i18n="delivered_on">Delivered on</th>
                            </tr>
                        </thead>
                ...
                <div class="nav-action-set">
                    <ul class="nav nav-pills mb-3 order-payment-tab" id="pills-tab" role="tablist">
                        <li class="nav-item " role="presentation">
                            <a class="nav-link rightbot active" id="pills-home-tab" data-toggle="pill" href="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true" data-i18n="order_details">Order Details</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link leftbot" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false" data-i18n="payments">Payments</a>
                        </li>
                    </ul>
                    <div class="nav-action-right-set">
                        ...
                        <div class="order-right-content">
                            <span style="display:block;" class="total_amount_top"></span>
                        </div>
                    </div>
                </div>
                                ...
                                <table class="custom-table" id="item_payment_table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-i18n="paid_amount">Paid Amount</th>
                                            <th data-i18n="collected_person">Collected Person</th>
                                        </tr>
                                    </thead>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="myModalLabel"><span><img src="assets/retailer.png" class="icon_add"></span><span data-i18n="add_offer">Add Offer</span></h4>
                        ...
                        <div class="modal-body">
                            <form class="forms">
                                <div class="form-control discount_type_box">
                                    <p class="discount_type" data-i18n="discount_type">Discount Type</p>
                                    <select class="input-field" id="discount_type">
                                        <option value="Rs" data-i18n="rupees">Rupees(Rs)</option>
                                        <option value="%" data-i18n="percentage">Percentage(%)</option>
                                    </select>
                                </div>
                                <div class="form-control discount_percentage_box">
                                    <p class="discount_type" data-i18n="discount_percentage">Discount Percentage</p>
                                    <select class="input-field" id="discount_percentage">
                                    </select>
                                </div>
                                <div class="form-control discount_amount_box">
                                    <p class="discount_amount" data-i18n="discount_amount">Discount Amount</p>
                                    <input class="input-field" id="discount_amount" placeholder="Enter Discount Amount" value="" onkeypress="return isNumber(event)" data-i18n-placeholder="enter_discount_amount">
                                </div>
                            </form>
                        </div>
                        <div class="modal-footer">
                            <a class="btn" data-dismiss="modal" style="color: #02b9f4;" data-i18n="close">Close</a>
                            <button type="button" class="btn model-btn" data-dismiss="modal" onclick="add_discount()" data-i18n="add_discount">Add Discount</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal fade" id="tableFreeDiscount" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="myModalLabel"><span><img src="assets/retailer.png" class="icon_add"></span><span data-i18n="edit_free_column">Edit Free Column</span></h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form class="forms">
                                <div class="form-control free_type_box">
                                    <p class="free_type" data-i18n="free_type">Free Type</p>
                                    <select class="input-field" id="free_type">
                                        <option value="Box" selected data-i18n="box">Box</option>
                                        <option value="Nos" data-i18n="piece">Piece</option>
                                    </select>
                                </div>
                                <div class="form-control free_quantity_box">
                                    <p class="free_quantity" data-i18n="free_quantity">Free Quantity</p>
                                    <input class="input-field" id="free_quantity" placeholder="Enter Free Quantity" value="" onkeypress="return isNumber(event)" data-i18n-placeholder="enter_free_quantity">
                                </div>
                            </form>
                        </div>
                        <div class="modal-footer">
                            <a class="btn" data-dismiss="modal" style="color: #02b9f4;" data-i18n="close">Close</a>
                            <button type="button" class="btn model-btn" data-dismiss="modal" onclick="add_free_product()" data-i18n="add_discount">Add Discount</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal fade" id="tableQuantityEdit" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="myModalLabel"><span><img src="assets/retailer.png" class="icon_add"></span><span data-i18n="edit_quantity">Edit Quantity</span></h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form class="forms">
                                <div class="form-control quantity_type_box">
                                    <p class="quantity_type" data-i18n="quantity_type">Quantity type</p>
                                    ...
                                    <select class="input-field" id="quantity_type">
                                        <option value="Box" selected data-i18n="box">Box</option>
                                        <option value="Nos" data-i18n="nos">Nos</option>
                                    </select>
                                </div>
                                <div class="form-control quantity_box">
                                    <p class="quantity" data-i18n="quantity">Quantity</p>
                                    <input class="input-field" id="quantity" placeholder="Enter Quantity" value="" onkeypress="return isNumber(event)" data-i18n-placeholder="enter_quantity">
                                </div>
                            </form>
                        </div>
                        <div class="modal-footer">
                            <a class="btn" data-dismiss="modal" style="color: #02b9f4;" data-i18n="close">Close</a>
                            <button type="button" class="btn model-btn" data-dismiss="modal" onclick="add_quantity()" data-i18n="update_quantity">Update Quantity</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal fade" id="editDiscountModal" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="myModalLabel"><span><img src="assets/retailer.png" class="icon_add"></span><span data-i18n="edit_discount">Edit Discount</span></h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                          ...
                          <div class="form-control quantity_box">
                            ...
                            <input class="input-field" id="edit_Discount_value" placeholder="Enter Discount" value="" onkeypress="return isNumber(event)">
                                ...
                                <div class="form-control discountEdit">
                                    <p class="discount" data-i18n="select_discount">Select Discount</p>
                        ...
                        <div class="modal-footer">
                            <a class="btn" data-dismiss="modal" style="color: #02b9f4;" data-i18n="close">Close</a>
                            <button type="button" class="btn model-btn" data-dismiss="modal" onclick="Update_Discount()" data-i18n="update_discount">Update Discount</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal fade " id="status-view" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h2 data-i18n="order_status">Order Status</h2>
                    </div>
                    ...
                    <div class="modal-body">
                        <div class="modal-inner-body">
                            <fieldset>
                                ...
                                <label for="delivery" data-i18n="delivery">Delivery</label>
                                <!-- &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                           <input type="radio" id="cancelled" name="radio" value="cancelled">
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="create-btn" id="apply_button" onclick="applyConfirm()" data-i18n="apply">Apply</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script>
            ...
            $(document).ready(function() {
                $('#sales_order').addClass('active-sidemenu');
                $('#fromDate').datepicker({
                    autoclose: true,
                    todayHighlight: true,
                    maxDate: 0
            ...
            function data_fetch() {
                ...
                table = $('#table_data').DataTable({
                    ...
                    'ajax': {
                        'url': api_path + "/distributor/server_sales_order.php?from_date=" + from_date + "&&to_date=" + to_date + "&&v_id=" + verfication_code + "&&dist_id=" + distributor_token,
            ...
            function particular_order_detail(token, sales_man_name) {
                ...
                $.ajax({
                    ...
                    order_text1 += '<div class="header_box mobileTop">';
                    ...
                    order_text1 += '</div>';
                    if (shop_data.delivery == "Pending") {
                        order_text1 += '<div class="appr-rej-set"><a href="javascript:void(0)" class="blue_btn" onclick=deliveryOrder(' + shop_data.order_token + ')>' + getGlobalTranslation("delivery_order") + '</a>';
                        order_text1 += '<a href="javascript:void(0)" onclick=cancel_order(' + shop_data.order_token + ')>' + getGlobalTranslation("cancel_order") + '</a></div>';
                    }
                    order_text1 += '</div>';
                    ...
                    order_text1 += '<p>' + getGlobalTranslation("date_time") + ': <span class="label_value">' + shop_data.date_time + '</span></p>';
                    order_text1 += '<p>' + getGlobalTranslation("amount") + ': <span class="label_value">' + numberFormatComma(shop_data.mrp_amount) + '</span></p>';
                    order_text1 += '<p>' + getGlobalTranslation("total_discount_amount") + ' : ₹ <span class="label_value" id="total_dis_amount"></span></p>';
                    order_text1 += '</div>';
                    order_text1 += '<div class="details-top-div">';
                    order_text1 += '<p>' + getGlobalTranslation("order_taken_by") + ': <span class="label_value">' + sales_man_name + '</span></p>';
                    order_text1 += '<p>' + getGlobalTranslation("gst") + '(18%): <span class="label_value">Rs.' + numberFormatComma(shop_data.gst_amount) + '</span></p>';
                    order_text1 += '</div>';
                    order_text1 += '<div class="details-top-div">';
                    order_text1 += '<p>' + getGlobalTranslation("items") + ': <span class="label_value">' + shop_data.items + '</span></p>';
                    order_text1 += '<p>' + getGlobalTranslation("paid_amount") + ': <span class="label_value">' + numberFormatComma(shop_data.paid_amount) + '</span></p>';
                    order_text1 += '</div>';
                    order_text1 += '<div class="details-top-div">';
                    if (shop_data.delivery == "Cancelled") {
                        order_text1 += '<p>' + getGlobalTranslation("cancelled_on") + ': <span class="label_value">' + shop_data.delivered_on + '</span></p>';
                    } else {
                        if (shop_data.delivered_on == "") {
                            order_text1 += '<p>' + getGlobalTranslation("delivered_on") + ': -</p>';
                        } else {
                            order_text1 += '<p>' + getGlobalTranslation("delivered_on") + ': <span class="label_value">' + shop_data.delivered_on + '</span></p>';
                        }
                    }
                    if (shop_data.delivery != "Cancelled") {
                        order_text1 += '<p>' + getGlobalTranslation("outstanding_amount") + ': <span style="color: tomato;">' + numberFormatComma(parseFloat(shop_data.total_outstanding).toFixed(0)) + '</span></p>';
                    }
                    ...
                    if (shop_data.bill_discount_amount != 0 || shop_data.bill_discount_percentage != 0) {
                        if (shop_data.bill_discount_percentage != 0) {
                            ...
                            $(".order-right-content > .total_amount_top").html(getGlobalTranslation("total_amount") + ': <span class="label_value">Rs.' + numberFormatComma((shop_data.billing_amount - discountPer).toFixed(2)) + '</span>');
                            $("span.discount_amount_down").html(getGlobalTranslation("discount") + '(' + shop_data.bill_discount_percentage + '%): <span class="label_value">Rs:' + discountPer + '</span>');
                            $("span.discount_amount_down").css("display", "block");
                        } else if (shop_data.bill_discount_amount != 0) {
                            $(".order-right-content > .total_amount_top").html(getGlobalTranslation("total_amount") + ': <span class="label_value">Rs.' + numberFormatComma((shop_data.billing_amount - shop_data.bill_discount_amount).toFixed(2)) + '</span>');
                            $("span.discount_amount_down").html(getGlobalTranslation("discount") + ' <span id="dis_amount"class="label_value">Rs:' + numberFormatComma((parseInt(shop_data.bill_discount_amount))) + '</span>');
                            $("span.discount_amount_down").css("display", "block");
                        }
                    } else {
                        $(".order-right-content > .total_amount_top").html(getGlobalTranslation("total_amount") + ': <span class="label_value">Rs.' + numberFormatComma(parseFloat(shop_data.billing_amount).toFixed(0)) + '</span>');
                    ...
                    var slno1 = 0;
                    html_th += '<tr>';
                    html_th += '<th>' + getGlobalTranslation("sl_no") + '</th>';
                    html_th += '<th>' + getGlobalTranslation("item_name") + '</th>';
                    html_th += '<th>' + getGlobalTranslation("item_code") + '</th>';
                    ...
                    if (shop_data.delivery == "Pending") {
                        html_th += '<th>' + getGlobalTranslation("action") + '</th>';
                    }
                    html_th += '</tr>';
                    ...
                    for (var key in item_data) {
                        ...
                        if (shop_data.delivery == "Pending" && item_data[key].is_free != 1) {
                            ...
                            html_text += '<td ><span style ="display:inline-block;color:#000;" id="discountEditvalue_' + key + '">' + numberFormatComma(item_data[key].discount) + '</span><a onclick="edit_discount(' + key + ')"><img src="assets/edit.png" class="edit_input" id="edit_Discount_value(' + key + ')" data-toggle="modal" data-target="#editDiscountModal"  alt=""></a></td>';
                            total_dis_amount += Number(item_data[key].discount);
                        } else if (shop_data.delivery == "Completed" && item_data[key].is_free != 1) {
                            html_text += '<td>' + numberFormatComma(item_data[key].amount) + '</td>';
                            html_text += '<td ><span style ="display:inline-block;color:#000;" id="discountEditvalue_' + key + '">' + numberFormatComma(item_data[key].discount) + '</span><a onclick="edit_discount(' + key + ')" hidden="hidden"><img src="assets/edit.png" class="edit_input" id="edit_Discount_value(' + key + ')" data-toggle="modal" data-target="#editDiscountModal"  alt=""></a></td>';
                            total_dis_amount += Number(item_data[key].discount);
                            ...
                            html_text += '<td>' + getGlobalTranslation("free") + '</td>';
                            html_text += '<td>-</td>';
                        }
                        if (shop_data.delivery == "Pending") {
                            if (item_data[key].is_free != 1) {
                    ...
                    let total = total_dis_amount.toFixed(2);
                    $("#total_dis_amount").append(total);
            ...
            function item_quantity_edit(key) {
                ...
                $.ajax({
                    ...
                    //console.log(item_productQuantity_data);
