...
<head>
    ...
    <title>Power soap - Gift Slot</title>
    <link rel="shortcut icon" href="assets/new-assets/logo.png">
    ...
    <link rel="stylesheet" href="css/gift_management.css<?php echo $js_cache_string; ?>">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control slot-modal_top" id="formGroupExampleInput" placeholder="Slot Name">
                          </div>
                          <div class="form-group  slot_modal_header">
 
                            <input type="text" class="form-control col-5" id="formGroupExampleInput" placeholder="Gift Name">
                            <input type="text" class="form-control col-4" id="formGroupExampleInput" placeholder="Qty">
                            <input type="text" class="form-control col-2" id="formGroupExampleInput" placeholder="Cost">
                          </div>
                          <div class="form-group  slot_modal_header">
                ...
                <div class="modal-footer">
                  ...
                  <button type="button" class="gift_model_btn">Create</button>
                </div>
              </div>
            </div>
          </div>
