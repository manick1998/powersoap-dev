        ...
        <section class="bg-white brad-4 full-height" id="daily_summary" >
            <div class="header_container">
                <div class="header-section">
                    <h1 class="header_main" data-i18n="daily_summary_item">Daily Summary</h1>
                </div>
            </div>
                ...
                <table class="custom-table" id="table_data">
                    <thead>
                        <tr>
                            ...
                            <th data-i18n="date_value">Date Value</th>
                            <th data-i18n="order_token">Order Token</th>
                            <th data-i18n="employee_token">Employee Token</th>
                            <th data-i18n="date">Date</th>
                            <th data-i18n="employee_name">Employee Name</th>
                            <th data-i18n="department">Department</th>
                            <th data-i18n="outlets_covered">Outlets Covered</th>
                            <th data-i18n="area">Area</th>
                            <th data-i18n="productivity">Productivity</th>
                        </tr>
                    </thead>
          ...
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel" data-i18n="outlets_covered">Outlets Covered</h4>
                ...
                <div class="modal-body">
                    <form  class="forms">
                     <div class = "class3">
                            <div class = "class1">
                                <h1 class="header_main" data-i18n="visited">Visited</h1>
                                    <p class="table_count">
                                        <span id="visited_count"></span>
                                    </p> 
                            </div>
                            <div class = "class2">
                                <h1 class="header_main" data-i18n="ordered">Ordered</h1>
                                    <p class="table_count">
            ...
            <div class="employee_header_container">
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link rightbot shopListBtn active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true" data-i18n="shop_list">Shop List</a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link leftbot skuListBtn" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false" data-i18n="sku_list">SKU List</a>
                    </li>
                </ul>
                <div class="tab-content" id="pills-tabContent" >
                    ...
                    <div class="items_list sameway">
                        <div class="total_sales col-2">
                            <p data-i18n="total_items">Total Items </p>
                            <span class="total_item_id"></span>
                        </div>
                        <div class="total_sales col-10" id="orderedShops">
                    ...
                    <div class="items_list sameway">
                            ...
                            <div class="total_sales col-lg-4" id="orderedProducts">
...
<script>
    ...
    $('#table_data tbody').on( 'click', '.view_link', function () {
        var unit_token = $(this).attr('data-unit_token');
        ...
        particular_date_emp_detail(unit_token);
    });
    var summary_date;
    ...
    function particular_date_emp_detail(unit_token){
        $(".se-pre-con").show();
        summary_date = date_time.substr(22,10);
        $("#single_view_date").html(date_value);
        ...
        $.ajax({
            ...
            for (var key in shop_data) {
                slno++;
                html_text += '<tr>';
                html_text += '<td><input class="table-checkbox" type="checkbox" name="check" value="'+shop_data[key].shop_token+'">'+slno+'</td>';
            ...
            if(department_name == "Sales"){
                 ...
                 shopBtn +=' <button class="btn_button" onclick="productLoading()" data-value="'+invoice_file_load.newLoad_list+'" id="productBtn">Generate Load List</button>';
    ...
    function productLoading(){
        var shop_token=[];
         $("input:checkbox[name=check]:checked").each(function() {
            shop_token.push($(this).val());
  });
            if (shop_token.length == 0) {
                swal({
            // title: "?",
            text: "Please Select Shop Name",
            icon: "warning",
            buttons: true,
            dangerMode: true,
                })
        ...
        if (willDelete) {
           ...
           var loadFileName = $("#productBtn").attr("data-value");
           var datas = {
            dashboard_code: verfication_code,
                distributor_token:distributor_token,
                selectedorder_date: date_value,
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url : "../TCPDF-main/examples/loadingSheetNew.php",
                data: json_data
            }).done(function(data) {
                swal("Loading Sheet Created successfully!", {icon: "success"}).then((value) => {
                             window.open('../invoice_pdf/'+data.data, '_blank');
