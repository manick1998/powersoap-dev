        ...
        <section class="bg-white brad-4 full-height" id="employee" >
            <div class="product_header_container">
                <div class="header-details ">
                    <h1 class="header_main">Employees List <span class="total_emp">Total Employees -<span id="total_employee_count"></span></span></h1>
                </div>
            </div>
            <!-- Nav tabs -->
            <ul class="nav nav-pills product_list mb-3" id="pills-tab" role="tablist">
                <li class="nav-item " role="presentation">
                <button onclick="show_employee()" class=" empshow nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true"><span><img class="icon_add" src="assets/icons/add_employee.svg" alt=""></span>Add Employee</button>
                </li>
                <li class="nav-item">
                <button class="nav-link" type="button" data-toggle="modal" data-target="#myModal">Upload CSV</button>
                </li>
                <li class="nav-item">
                    <button class="nav-link btn_employees" type="button"><a class="a_button" href="assets/csv/sampleEmployeeCsv.csv" download>Sample CSV File</a></button>
                </li>
            </ul>
            ...
            <div class="header_container" >
                <div class="header-section">
                    <div class="inventory-top">
                        <h1 class="header_main"><span class="twoinspace"><img src="assets/back.png" onclick="back_add_employee()" alt=""> Add New Employee</span></h1>
                    </div>
                </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <form  class="forms">
                            <div class="form-control add_employee_name_box">
                                <p class="add_employee_name">Employee Name <span id="mandatory_icon">*</span></p>
...
-->
                             <div class="form-control add_employee_mobilenumber_box">
                                <p class="add_employee_mobilenumber">Mobile Number <span id="mandatory_icon">*</span></p>
                                <input class="input-field" id="add_employee_mobilenumber" placeholder="Please Enter Mobilenumber" onkeypress="return isNumber(event)">
                            </div> 
                            <div class="rate">
                                <div class="rates add_employee_joindate_box">
                                     <input class="form-control box_form" name="date" id="add_employee_joindate" type="text"  placeholder="Joining Date" readonly> 
                                </div>
                                <div class="rates add_employee_dob_box">
                                    <input class="form-control box_form" name="date" id="add_employee_dob" type="text" placeholder="Date of Birth"  readonly>     
                                </div>
                            </div>
                        </form>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="form-control add_employee_department_box">
                            <p class="add_employee_department">Department <span id="mandatory_icon">*</span></p>
                        ...
                        <div class="form-control add_employee_email_id_box">
                            <p class="add_employee_email_id">Email Address</p>
            ...
            <div class="bottom_container" >
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12"> 
                        <form  class="forms">
                            ...
                            <div class="form-control add_employee_pincode_box">
                                <input class="input-field" id="add_employee_pincode" placeholder="Pincode" onkeypress="return isNumber(event)">
                            </div> 
                        </form>
                    </div>
                ...
                <div class="add_disp">
                    ...
                    <button class="btn_product" onclick="add_employee()" id="add_employee_button">Add New Employee</button>
                </div>
            </div>
        </section>
         <section class="bg-white brad-4 full-height" id="employee_edit" style="display: none;">
            <div class="header_container" >
                <div class="header-section">
                    <div class="inventory-top">
                        <h1 class="header_main"><span class="twoinspace"><img src="assets/back.png" onclick="back_edit_employee()" alt=""> Edit Employee</span></h1>
                    </div>
                </div>
                <div class="add_new_top">
                    <div class="col-lg-2 col-md-12 col-sm-6 col-xs-12">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <form  class="forms">
                            ...
                            <div class="form-control edit_employee_name_box">
                                <p class="edit_employee_name">Employee Name</p>
...
-->
                             <div class="form-control edit_employee_mobilenumber_box">
                              ...
                              <div class="form-control edit_employee_joindate_box">
                                ...
                                <input class="input-field box_form" id="edit_employee_joindate" placeholder="Joining Date" maxlength="10">
                            </div> 
                              <div class="form-control edit_employee_dob_box">
                                <p class="edit_employee_dob">Date of Birth</p>
                                <input class="input-field box_form" id="edit_employee_dob" placeholder="Date of Birth" maxlength="10">
                            </div>
                        </form>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <form class="form">
                            <div class="form-control edit_employee_gender_box">
                                <p class="edit_employee_gender">Gender</p>
                            ...
                            <div class="form-control edit_employee_email_id_box">
                             ...
                             <div class="form-control edit_employee_blood_group_box">
                                <p class="edit_employee_blood">Select Blood Group</p>
...
-->
            ...
            <div class="bottom_container">
                ...
                <div class="add_disp">
                    ...
                    <button class="btn_product" onclick="update_employee()" id="update_employee_button">Update Employee</button>
                </div>
            </div>
        </section>
            ...
            <div class="header_container mrgzro" >
                ...
                <div class="add_new_top bot_line inventory-body-section">
                    ...
                    <div class="inventory-body-right">
                        ...
                        <div class="part">
                            <div class="codelevel">
                                <p>Age : <span id="single_employee_age">34 Years</span></p>
