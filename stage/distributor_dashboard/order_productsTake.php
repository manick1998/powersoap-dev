 ...
 $freeproduct_array = [];
       ...
       cellspacing="0" style="margin:0;padding:0;">
        ...
        <table style="table-layout:fixed;border-collapse: collapse;border: 1px solid #ccc;width: 100%;text-align: left;font-size: 10px;line-height: 22px;font-family: sans-serif;">
            ...
            <tr>
                ...
                <th style="border: 1px solid #ccc;padding: 8px 10px;text-align:center;"><b>GST Amt 18%</b></th>
    ...
    while($row = mysqli_fetch_array($result)){
        ...
        foreach($details as $value){
            ...
            $orderproduct_array[] = "('$order_id','$value->product_token','$value->product_total_cost','$value->piece_count','$gst_amount','$value->quantity','0','$offer_token','$value->discount_percent','$product_final_amount','$units','0','0','0','0','$item_gst_rate','$indiaDateTime')";
                  ...
                  if($row1["limit_box"] <= $value->quantity){
                     ...
                     if($free_box_val > 0) {
                        ...
                        $freeProduct_count = $free_box_val1*$row1["free_box"];
                         ...
                         $orderproduct_array[] = "('$order_id','$value->product_token','$value->product_total_cost','$value->piece_count','0','$freeProduct','0','0','0','0','$units','1','0','0','0','$item_gst_rate','$indiaDateTime')";
                     }
                  }
              }
