...
$area_location = isset($json_input->area_location) ? mysqli_real_escape_string($link, $json_input->area_location) : "";
$area = isset($json_input->area) ? mysqli_real_escape_string($link, $json_input->area_name) : "";
...
VALUES('$schedule_rep_token','$sales_rep_token','$latitude','$longitude','$area_location','$area','$currentDate','$order')");
if (!$sql1) {
