...
$employeeQuery = mysqli_query($link, "SELECT `admin_distributor_token` FROM `employees` WHERE `token`='$distributor_token'");
...
$sql1 = mysqli_query($link,"SELECT 
                ...
                WHERE
                    employees__division_mapping.employee_token = $distributor_token AND employees__division_mapping.delete_status = '1' and products.delete_status =1 GROUP BY products.token");
