...
VALUES ('$token','$order_number','$currnetDateTime','$order_type','$shop_mapping_token','$distributor_token','$distributor_token','$final_product_item_count','$bill_amount','0','pending')");
...
foreach( $product_array as $key => $data) {
     ...
     if($is_free == false){
             ...
             if($units == 'Box'){
                ...
                $bill_amount+= $product_amount_value;
         ...
         ('$token','$product_token','$product_per_price','$piece_count','$product_per_gst','$order_qty','$bill_amount','$units','0','0' ,'$currnetDateTime')");
