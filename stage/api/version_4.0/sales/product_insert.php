...
VALUES ('$token','$order_number','$currnetDateTime','$order_type','$shop_token','$sale_id','$dist_token_value','$final_product_item_count','$bill_amount','0','pending','$unit_shop_count')");
...
foreach( $product_array as $key => $data) {
     ...
     if($is_free == false){
        ...
        //                 $product_box_count = round($free_box_val);
        //                 $units_offer = 'Box';
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://powersoaps.online/stage/TCPDF-main/examples/salesOrderInvoice.php',
