...
//schedule_token
$sql=mysqli_query($link,"SELECT  `rep_schedule_token` FROM `schedule_sales_rep` WHERE `sales_rep_token`='$sales_rep_token'");
...
VALUES('$schedule_token','$sales_rep_token','$schedule_date','$state_token','$region_token','$area_token','$distributor_token','$currentDate','1')");
if($insert) {
        $obj->status_code=200; 
