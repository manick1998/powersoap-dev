...
$outstanding_amount = mysqli_query($link,"SELECT
                ...
                WHERE
                    shop.token = $shop_id AND shop.distributor_token = $distributor_token  AND orders.delivery != 'Cancelled'");
...
$order_hisyory = mysqli_query($link,"SELECT
                                    ...
                                    INNER JOIN shop ON shop.token=orders.shop_token 
                                    WHERE
                                     shop.token = $shop_id AND shop.distributor_token = $distributor_token ORDER BY orders.id DESC");
