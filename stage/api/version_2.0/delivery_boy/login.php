...
$obj = new stdClass;
$sql1 = mysqli_query($link,"SELECT 1 FROM `employees` inner JOIN deparment ON deparment.token=employees.deparment_token WHERE `mobile_number`= $mobile AND deparment.token=93402780 AND block_status='1'");
