...
if($employee_id){
$insert_shop = mysqli_query($link,"INSERT INTO `shop`( `token`, `name`, `date_time`, `unit_token`,  `shop_type_code`, `slot`, `distributor_token`, `mobile_number`,
							 `contact_person`, `join_date`, `license_number`,license_image,  `delete_status`, `address`, `city`, `pincode`, `coordinates`,`created_by`) VALUES ('$token','$shop_name','$date','$units_id','$shop_type','0%','$ditributor_id','$contact_number','$contact_name','$date','$licence_number','$upload_url', '1','$address','$city','$pincode','$coordinates','$employee_id')");
