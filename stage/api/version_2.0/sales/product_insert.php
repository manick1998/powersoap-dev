...
$currnetDateTime =  date("Y-m-d H:i:s");
 ...
 $order_insert = mysqli_query($link,"INSERT INTO `orders`( `token`,`order_number`, `date_time`, `order_type`, `shop_token`, `employee_token`, `items`, `billing_amount`,`delivery`) 
VALUES ('$token','$order_number','$currnetDateTime','$order_type','$shop_token','$sale_id','$item_count','0','pending')");
