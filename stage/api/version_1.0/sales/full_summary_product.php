...
$summary_product = mysqli_query($link,"SELECT
                        ...
                        WHERE
                            orders.employee_token = $employee_id  AND units__shop_mapping.delete_status = 1 AND orders.delivery='Pending' AND daily_schedule.schedule_date = '$dayname' GROUP BY products.token");
