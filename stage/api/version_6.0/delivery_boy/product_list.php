...
$sql1 = mysqli_query($link,"SELECT 
                ...
                WHERE
                    employees__division_mapping.employee_token = $distributorToken AND employees__division_mapping.delete_status = '1' and ((`products`.`delete_status`='2' AND `stock__distributor`.`stock_in_hand` > '0') ||  `products`.`delete_status`='1') GROUP BY products.token");
