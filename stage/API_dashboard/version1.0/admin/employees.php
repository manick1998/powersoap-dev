...
-->
                        ...
                        <div class="col-md-2">
                            <label class="upload_label1" for="address_proof1_upload">
                                <div class="upload_file1">
                                    ...
                                    <iframe class="uploadimg1" id="address_proof1_url_pdf" frameBorder="0"></iframe>
                    ...
                    <div class="add_disp">
                                ...
                                <div class="data_view_image">
                                    <label class="upload_label2" for="address_proof2_upload">
                                        <div class="upload_file1">
                                            ...
                                            <iframe class="uploadimg1" id="address_proof2_url_pdf" frameBorder="0"></iframe>
                                ...
                                <div class="data_view_image">
                                    <label class="upload_label2" for="address_proof3_upload">
                                        <div class="upload_file1">
                                            ...
                                            <iframe class="uploadimg1" id="address_proof3_url_pdf" frameBorder="0"></iframe>
                                ...
                                <div class="data_view_image">
                                    <label class="upload_label2" for="address_proof4_upload">
                                        <div class="upload_file1">
                                            ...
                                            <iframe class="uploadimg1" id="address_proof4_url_pdf" frameBorder="0"></iframe>
                                ...
                                <div class="data_view_image">
                                    <label class="upload_label2" for="address_proof5_upload">
                                        <div class="upload_file1">
                                            ...
                                            <iframe class="uploadimg1" id="address_proof5_url_pdf" frameBorder="0"></iframe>
                        ...
                        <button class="btn_product" onclick="add_employee()" id="add_employee_button">Add New Distributor</button>
                    </div>
                </div>
            </section>
                        ...
                        <div class="col-md-2">
                            <label class="upload_label1" for="edit_address_proof1_upload">
                                <div class="upload_file1">
                                    ...
                                    <iframe class="uploadimg1" id="edit_address_proof1_url_pdf" frameborder="0"></iframe>
                                ...
                                <div class="data_view_image">
                                    <label class="upload_label2" for="edit_address_proof2_upload">
                                        <div class="upload_file1">
                                            ...
                                            <iframe class="uploadimg1" id="edit_address_proof2_url_pdf" frameborder="0"></iframe>
                                ...
                                <div class="data_view_image">
                                    <label class="upload_label2" for="edit_address_proof3_upload">
                                        <div class="upload_file1">
                                            ...
                                            <iframe class="uploadimg1" id="edit_address_proof3_url_pdf" frameborder="0"></iframe>
                                ...
                                <div class="data_view_image">
                                    <label class="upload_label2" for="edit_address_proof4_upload">
                                        <div class="upload_file1">
                                            ...
                                            <iframe class="uploadimg1" id="edit_address_proof4_url_pdf" frameborder="0"></iframe>
                                ...
                                <div class="data_view_image">
                                    <label class="upload_label2" for="edit_address_proof5_upload">
                                        <div class="upload_file1">
                                            ...
                                            <iframe class="uploadimg1" id="edit_address_proof5_url_pdf" frameborder="0"></iframe>
        ...
        <script>
                                ...
                                var region_token =$(this).val();
                                    ...
                                    $.ajax({
                                        ...
                                        success:function(response){
                                            $("#add_employee_area").empty();
                                            var insert_area='';
                                            insert_area += '<option  value="">Select Area</option>';
                                            response.forEach(function(item,index){
                                                    
                                                    //if (item.area_token == item.area_token) {
                                                        
                                                        // $("#area_drop").remove("#area_drop")
                                                    insert_area += `<option  id="area_drop" value="${item.area_token}">${item.area_name}</option>`;
                                                    
                                            });
                                            $("#add_employee_area").append(insert_area);
            ...
            $(document).ready(function() {
                ...
                table = $('#table_data').DataTable({
                    ...
                    'ajax': {
                        'url': api_path + "/admin/serverEmployeeList.php?v_id="+verfication_code+"&state_id="+admin_state_id,
                    },
                    "order": [
                        [0, "DESC"]
                    ],
            ...
            $('#table_data tbody').on('click', '.sendcrds', function() {
                ...
                $.ajax({
                    ...
                    if (data.code == "201") {
                        swal("Distributor Credentials sent to mail and Phone number successfully!", {icon: "success"});
                    } else {
                        swal(data.message);
                    }
                });
                ...
                $.ajax({
                    ...
                    for (var key1 in attachement_data) {
                        ...
                        if(attachImgExten == 'pdf'){
                             html += '<iframe class="uploadimg1" src="'+ attachement_data[key1].attachment +'" frameborder="0"></iframe>';
                        }else{
...
//                var val14 = value_check('add_employee_street', employee_street, 'text_box');
                ...
                if (val1 == true && val3 == true && val7 == true && val8 == true && val10 == true && val11 == true && val12 == true && val13 == true && val15 == true && val16 == true && val17 == true) {
...
//                    'employee_street': employee_street,
            ...
            function edit_employee(token) {
                ...
                $.ajax({
                   ...
                   // console.log(emp_data);
                    ...
                    area_dropdown +=`<option  value="${emp_data[0].employee_area}">${emp_data[0].employee_area}</option>`
                    $("#edit_employee_area").append(area_dropdown);
                    //console.log($("#edit_employee_region").val());

                    var region_token =$("#edit_employee_region").val();
                    var employeeToken =$("#edit_employee_token").val();
                                ...
                                $.ajax({
                                    type: "POST",
                                    dataType: "json",
                                    url: api_path + "/admin/select_edit_employee_area.php",
                                    data: json_data,

                                    success:function(response){
                                        var edit_insert_area='';
                                        //console.log(response);
                                        //console.log(response[0].one_area);
                                        
                                             //edit_insert_area += `<option  value="">${response[0].one_area}</option>`;
                                        ...
                                        response.forEach(function(item,index){
                                            ...
                                            edit_insert_area += `<option  id="area_drop" value="${item.employee_area}">${item.employee_area}</option>`;
    ...
    $.ajax({
        ...
        success:function(response){
            $("#edit_employee_area").empty();
            var edit_insert_area='';
            edit_insert_area += '<option  value="Select Area">Select Area</option>';
            response.forEach(function(item,index){
