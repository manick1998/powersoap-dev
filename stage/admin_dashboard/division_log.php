                ...
                <div class="tab-pane active" id="state1">
                    <section class="bg-white brad-4 full-height" >
                        <div class="product_header_container">
                            ...
                            <h1 class="header_main"><span class="twoinspace">Division Log</span></h1>
                            </div>
                        </div>
                        <!-- Nav tabs -->
                            ...
                            <div class="tab-pane active fade show" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                <table class="custom-table" id="table_data">
                                    <thead>
                                        <tr>
                                            <th>Divison name</th>
                                            <th>Before_Division Name</th>
                                            <th>Afer_Division Name</th>
                                            <th>created_by</th>
                                            <th>date_time</th>
                                            <th>status</th>
                                        </tr>
        ...
        <script>
            ...
            $.ajax({
                ...
                data.data.forEach(function(item,index){
                    ...
                    html += `<td>${item.before_division}</td>`
                    html += `<td>${item.after_division}</td>`
