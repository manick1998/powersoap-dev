                ...
                <div class="tab-pane active" id="state1">
                    <section class="bg-white brad-4 full-height" >
                        <div class="product_header_container">
                            ...
                            <h1 class="header_main"><span class="twoinspace">Admin Stock Log</span></h1>
                            </div>
                        </div>
                        <!-- Nav tabs -->
        ...
        <script>
            ...
            $.ajax({
                ...
                data.data.forEach(function(item,index){
                    ...
                    html += `<td>${item.before_stock}</td>`
                    html += `<td>${item.updated_stock == ""?"-":item.updated_stock}</td>`
                    html += `<td>${item.admin_name}</td>`
                    // html += `<td>${item.add_date_time}</td>`
                    html += `<td>${item.update_date_time}</td>`
                    '</tr>'
                });
