...
?>
    ...
    <style>
        ...
        .atach_img img {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
            width: 200px;
            cursor: pointer;
                ...
                <div class="tab-pane active" id="state1">
                    <section class="bg-white brad-4 full-height" >
                        <div class="product_header_container">
                            ...
                            <h1 class="header_main"><span class="twoinspace">Order Log</span></h1>
                                <!-- <h1 class="header_main">Order Log</h1> -->
                            </div>
                        </div>
                        <!-- Nav tabs -->
