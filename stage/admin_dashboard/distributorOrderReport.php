    ...
    <div class="sidebar" id="sidebar6"></div> -->
        ...
        <main class="main-contents">
            <section class="bg-white brad-4 full-height" id="head">
                <div class="header_container">
                    <div>
                        <h1 class="header_main">Distributor Orders Report</h1>
                ...
                <div class="dataTables_filter">
                    <form class="formdield">
                        ...
                        <div class="form-group">
                            <select id="selectDistributor" class="selectField form-control">
                                <option value=""></option>
                            </select>
                        </div>
        ...
        <script>
            ...
            function reportOverall() {
                ...
                var distributor = $('#selectDistributor :selected').val();
                var data = {
                    type: "date_filter",
                    state: state,
                    region: region,
                ...
                if (fromDate != '' && toDate != '' && state != '' && region != '' && distributor != '') {
                    $.ajax({
                        type: "POST",
                        dataType: "json",
                        url: api_path + "/admin/distributorOrderReport.php",
                        data: json_data,
                    }).done(function(data) {
                        ...
                        $("#table_data").DataTable({
                            ...
                            buttons: [{
                                    ...
                                    title: 'DistributorOrderReport:' + $('#fromDate').val() + 'to' +
                                        $('#toDate').val(),
                                    exportOptions: {
                                        columns: [0, 1, 2, 3, 4, 5]
                                    },
            ...
            $(document).on('change', '#selectRegion', function() {
                ...
                $.ajax({
                    ...
                    $('#selectDistributor').html(html_text);
                });
            });
        </script>
    </body>
