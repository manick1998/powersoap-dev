                ...
                <div class="tab-pane active" id="state1">
                    <section class="bg-white brad-4 full-height" >
                        <div class="product_header_container">
                            ...
                            <h1 class="header_main"><span class="twoinspace">Offer Log</span></h1>
                            </div>
                        </div>
        ...
        <script>
            ...
            $.ajax({
                ...
                data.data.forEach(function(item,index){
                    console.log(item);
                    html += `<tr>`
                    html += `<td>${item.offer_name}</td>`
                    html += `<td>${item.offer_percentage}</td>`
                    html += `<td>${item.state_name}</td>`
                    html += `<td>${item.division_name}</td>`
                    html += `<td>${item.minimum_purchase_amount}</td>`
