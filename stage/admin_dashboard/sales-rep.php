                        ...
                        <div class="modal-inner-body">
                            <div class="banner-option-box">
                                <div class="popup-image-box">
                                    ...
                                    <div class="form-control edit_resignation_date_box">
                                        <p class="input-field edit_resignation_date">Resignation Date</p>
                                        <input type="date" id="edit_resignation_date" class="input-field">
                                    </div>
        ...
        <script>
            ...
            function add_sales_rep(){
                ...
                if (val1 == true && val2 == true && val3 == true && val4 == true && val5 == true && val6 == true) {
                    ...
                    var all_check = (val1 == true && val2 == true && val3 == true && val4 == true && val5 == true && val6 == true);
                    if(all_check==false){
            ...
            $(document).on('click',"#editbtn",function(){
                ...
                $.ajax({
                    ...
                    // --- LOAD RESIGNATION DATE INTO MODAL INPUT ---
                    $("#edit_resignation_date").val(emp_data[0].resignation_date || '');
            ...
            function update_sales_rep_finish() {
                ...
                var sales_rep_mobilenumber = $("#edit_sales_rep_mobilenumber").val();
                var state_token = $("#edit_state_name").val();
                var resignation_date = $("#edit_resignation_date").val();
                ...
                var datas = {
                    ...
                    sales_rep_mobilenumber: sales_rep_mobilenumber,
                    state_token: state_token,
                    resignation_date: resignation_date, // PASS RESIGNATION DATE HERE
